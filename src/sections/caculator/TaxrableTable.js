  ...
  <TableContainer sx={{ paddingTop: 3 }}>
    <Table>
      ...
      <TableBody>
        ...
        <TableRow>
          <TableCell>
            <Typography>From over 10 million VND to 18 million VND</Typography>
          </TableCell>
          <TableCell>
        ...
        <TableRow>
          <TableCell>
            <Typography>From over 18 million VND to 32 million VND</Typography>
          </TableCell>
          <TableCell>
        ...
        <TableRow>
          <TableCell>
            <Typography>From over 32 million VND to 52 million VND</Typography>
          </TableCell>
          <TableCell>
        ...
        <TableRow>
          <TableCell>
            <Typography>From over 52 million VND to 80 million VND</Typography>
          </TableCell>
          <TableCell>
